...
import Flight from "./src/modules/movement.ts/flight";
import Freecam from "./src/modules/movement.ts/freecam";
import InventoryMove from "./src/modules/movement.ts/inventory_move";
